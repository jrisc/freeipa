...
from ipapython.version import KRB5_VERSION_MAJOR, KRB5_VERSION_MINOR
...
class KrbInstance(service.Service):
    ...
    def create_instance(self, realm_name, host_name, domain_name, admin_password, master_password, setup_pkinit=False, pkcs12_info=None, subject_base=None):
        ...
        if KRB5_VERSION_MAJOR > 1 or (KRB5_VERSION_MAJOR == 1 and KRB5_VERSION_MINOR >= 20):
            self.step("set PAC ticket signature support flag", self.pac_tkt_sign_support_enable)
